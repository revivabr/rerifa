    ...
    <footer className="mt-32 bg-gradient-to-b from-stone-50 to-stone-100 border-t border-black/[0.05] text-primary">
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-16 md:grid-cols-3">
          ...
          <div className="space-y-6">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-primary/40">Projetos Apoiados</h4>
          ...
          <div className="space-y-6">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-primary/40">Transparência & Segurança</h4>
        ...
        <div className="mt-20 flex flex-col items-center justify-between gap-6 border-t border-black/[0.05] pt-10 text-[11px] font-medium text-primary/40 md:flex-row">
