    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Escolha a campanha para ver o ranking de vendedores</p>
        </div>
      </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((c) => (
            <Link
              ...
              to="/admin/ranking/$id"
              params={{ id: c.id }}
              className="group relative overflow-hidden rounded-2xl border border-border bg-card shadow-premium transition hover:scale-[1.02] hover:border-yellow-400"
            >
              <div className="aspect-[16/9] w-full overflow-hidden bg-secondary">
                {c.banner_url ? (
                  ...
                  <div className="h-full w-full bg-gradient-to-br from-primary to-primary-glow flex items-center justify-center">
                    <Crown className="h-12 w-12 text-white/40" />
                  </div>
                )}
              </div>
              <div className="p-4 space-y-2">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <span className="inline-flex items-center gap-1 text-sm font-bold text-primary group-hover:text-yellow-600">
