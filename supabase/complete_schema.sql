-- =====================================================
-- Reviva Brasil — Rifa Solidária — Estrutura Completa
...
-- Função de checagem de Admin (SECURITY DEFINER necessária para RLS)
...
-- Função para expirar pedidos pendentes
...
-- Trigger para gerar números ao criar campanha
...
-- Orders (Restrito a Admins - Buyers usam Service Role via Server Function)
...
-- Order Numbers
create policy "order_numbers admin read" on public.order_numbers for select to authenticated using (public.is_admin());
