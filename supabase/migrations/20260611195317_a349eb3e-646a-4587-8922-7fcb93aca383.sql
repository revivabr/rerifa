-- Adiciona a coluna seller_name à tabela orders
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS seller_name TEXT;

-- Atualiza a função reserve_numbers para incluir p_seller_name
...
BEGIN
  ...
  -- 4. Create the order with seller_name
...
-- Garante as permissões para a nova assinatura da função
